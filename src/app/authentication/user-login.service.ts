...
export class UserLoginService {
  private onLoginSuccess = (
    ...
    //TODO: start a timer to Auto Refresh the Auth-token after 1 hours
    this.refreshToken();
  };

  // authTokenRefreshTimer: any;
  refreshToken() {
    // clearTimeout(this.authTokenRefreshTimer);
    setInterval(() => {
      this.cognitoUtil.refresh(); //Refresh Acccess Token after 59 minutes interval
    }, 1000 * 60 * 59);
  }
